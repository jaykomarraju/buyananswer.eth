...
const DisconnectConnect = ({ onDisconnect }) => {
...
//   };
    ...
    const handleClick = () => {
        // This should disconnect the wallet
        // Call the onConnect prop here
        onDisconnect(false, null);
    }

  return <Button onClick={handleClick}>DISCONNECT YOUR WALLET</Button>
  ;
};

export default DisconnectConnect;
